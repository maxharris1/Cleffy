/**
 * The stylistic era a score is played in. KEEP IN LOCKSTEP with
 * services/omr-service/src/era.ts (and supabase/functions/_shared/era.ts): the
 * worker stamps this on ScoreData, and the client uses the same mapping to
 * notice a title edit that would change pedalling or ornament spelling.
 */
