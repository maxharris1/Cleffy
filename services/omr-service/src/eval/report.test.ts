...
const record = (
    ...
    structure: {
        ...
        warnings: [],
        flags: {
            measureUnderfull: false,
            measureOverfull: false,
            tempoDefaulted: false,
            repeatsIgnored: false,
            jumpsIgnored: false,
        },
    },
    composite,
...
describe('diffBaseline', () => {
    ...
    it('flags movementCountOk and merge2', () => {
        ...
        const after = record(90, 80, 1, 80, {
            structure: { ...before.structure, movementCountOk: false },
